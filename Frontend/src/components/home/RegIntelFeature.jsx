...
export default function RegIntelFeature() {
    ...
    const handleMobileTabClick = (key) => {
        setActive(key);
        // Small delay to allow state update and then scroll
        setTimeout(() => {
    ...
    return (
        <div id="regintel" className="scroll-mt-24">
                            ...
                            {tabs.map((t) => (
                                <button
                                    ...
                                    className={` cursor-pointer w-full text-left p-4  rounded-xl transition-all duration-200 flex gap-4 items-start group bg-white ${t.key === active
                                        ? "shadow-lg border border-emerald-500 ring-1 ring-emerald-500/20"
                                        : "shadow-sm border border-slate-100 hover:shadow-md hover:border-emerald-200"
                                        }`}
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="relative mb-6" ref={contentRef}>
                        ...
                        <div className="absolute  -top-15 -right-1 z-20 flex flex-col-3 gap-2">
                            ...
                            <div className="bg-white text-slate-900 px-3 py-2 rounded-xl shadow-lg border border-slate-200">
                                <div className="text-lg font-bold leading-none">360°</div>
                                <div className="text-[9px] font-medium uppercase text-slate-500">Visibility</div>
                            </div>
                        </div>
